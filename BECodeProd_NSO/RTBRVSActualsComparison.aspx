<%@ Page Language="C#" Title="RTBR VS Actuals Comparison" AutoEventWireup="true" CodeBehind="RTBRVSActualsComparison.aspx.cs" Inherits="BECodeProd.RTBRVSActualsComparison" %>
           ...
           <tr>
                            ...
                            <td class="FormControls">
                                <table style="width:30px">
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlSU" runat="server"  
