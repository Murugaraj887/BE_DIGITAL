<%@ Page Language="C#" AutoEventWireup="true" Title="DM Details"
    Inherits="DMDetails" Codebehind="DMDetails.aspx.cs" %>
...
<body>
    ...
    <div>
         ...
         <asp:GridView ID="grdBEDMView" runat="server" AutoGenerateColumns="False" 
             ...
             OnRowCreated="grdBEDMView_RowCreated" ShowFooter="True"
                                                    CssClass="mGrid">
                                                    <Columns>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                         ...
                                                         <asp:TemplateField HeaderText="DM Mail Id" SortExpression="SkillType" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:label ID="lblDMMonth1" Text='<%# Bind("txtDMMailId") %>' 
                                                        ...
                                                        <asp:TemplateField HeaderText="Month1" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <asp:label ID="lblDMMonth1" Text='<%# Bind("fltDMMonth1BE") %>' 
                                                                     runat="server"></asp:label>
                                                            </ItemTemplate>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        ...
                                                        <asp:TemplateField HeaderText="Month2" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <asp:label ID="lblDMMonth2" Text='<%# Bind("fltDMMonth2BE") %>'
                                                                   runat="server"></asp:label>
                                                            </ItemTemplate>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        ...
                                                        <asp:TemplateField HeaderText="Month3" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <asp:label ID="lblDMMonth3" Text='<%# Bind("fltDMMonth3BE") %>'
                                                                   runat="server"></asp:label>
                                                            </ItemTemplate>
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        ...
                                                        <asp:TemplateField HeaderText="BETotal" SortExpression="TotalVol" ItemStyle-HorizontalAlign="Right">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBKLeft" Text='<%# Bind("fltDMQuarterBE") %>' runat="server"></asp:Label>
...
<ItemStyle HorizontalAlign="Right" Wrap="false"></ItemStyle>
                                                               ...
                                                               <asp:TemplateField HeaderText="DM Remarks" SortExpression="SkillType" ItemStyle-HorizontalAlign="left">
                                                            <ItemTemplate>
                                                                <asp:label ID="txtDMReamrks" Text='<%# Bind("txtDMBERemarks") %>' 
                                                                    runat="server"></asp:label>
                                                            </ItemTemplate>
...
<ItemStyle HorizontalAlign="Right" Wrap="True"></ItemStyle>
                                                        ...
                                                        <FooterStyle CssClass="grdfont" HorizontalAlign="Right" />
                                                        </asp:GridView>
                                                        <br />
...
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                        ...
                                                        <br />
                                                            ...
                                                            <asp:GridView ID="grdBEDMViewVol" runat="server" AutoGenerateColumns="False"  OnRowCreated="grdBEDMViewVol_RowCreated"
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                         ...
                                                         <asp:TemplateField HeaderText="DM Mail Id" SortExpression="SkillType" ItemStyle-HorizontalAlign="Center">
                                                           ...
                                                           <asp:BoundField DataField="fltDMMonth1onsite" HeaderText="DM1Onsite" 
                                                                ItemStyle-HorizontalAlign = "Right" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>
                <asp:BoundField DataField="fltDMMonth1offsite" HeaderText="DM1Offshore" ItemStyle-HorizontalAlign="Right" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>
                <asp:BoundField DataField="fltDMMonth2onsite" HeaderText="DM2Onsite" ItemStyle-HorizontalAlign = "Right" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>
                <asp:BoundField DataField="fltDMMonth2offsite" HeaderText="DM2Offshore" ItemStyle-HorizontalAlign = "Right" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>
                <asp:BoundField DataField="fltDMMonth3onsite" HeaderText="DM3Onste" ItemStyle-HorizontalAlign = "Right" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>
                <asp:BoundField DataField="fltDMMonth3offsite" HeaderText="DM3OffShore" ItemStyle-HorizontalAlign = "Right" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>
                 <asp:BoundField DataField="fltDMTotalonsite" HeaderText="DM3OffShore" ItemStyle-HorizontalAlign = "Right" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>
                  <asp:BoundField DataField="fltDMTotaloffsite" HeaderText="DM3OffShore" ItemStyle-HorizontalAlign = "Right" >

<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>

                <asp:BoundField DataField="fltDmTotalVolume" HeaderText="Total" ItemStyle-HorizontalAlign = "Right" >
<ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                            </asp:BoundField>
                                                        </Columns>
                                                        
                                                                <FooterStyle HorizontalAlign="Right" CssClass="grdfont" />
