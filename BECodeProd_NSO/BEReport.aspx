<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BEReport.aspx.cs" Title="SDM BE Report"
    Inherits="BEReport" %>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <td style="font-family: Verdana;font-size: 10px" class="style4">
                                <div style="float:left"><asp:CheckBox ID="chkType" runat="server"  /></div> <div style="float:left">Full Report</div>
                            </td>
                            <%--<td class="FormLabel">
                                Type:&nbsp;
                            </td>
                            <td class="FormControls">
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlfetchingType" runat="server" Font-Names="Calibri" Font-Size="11px"
