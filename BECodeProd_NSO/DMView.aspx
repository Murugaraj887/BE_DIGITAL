<%@ Page Title="Digital BE DATA - DM" Language="C#" MasterPageFile="~/Site.Master"
    EnableViewState="true" AutoEventWireup="true" Inherits="DMView" Codebehind="DMView.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
  ...
  .form-control {
    ...
    <style type="text/css">
        ...
        #MainContent_grdBEDMViewHorizontalRail
        {
            display:none !important;
       
        }
        #MainContent_grdBEDMViewHorizontalBar
        {
            display:none !important;
        }
           .wid
...
//            i = parseInt(no) + 2;
//            var hndfMcc = 'MainContent_grdBEDMView_hdnfmcc_' + no;
//            var hndfldname = 'MainContent_grdBEDMView_hdnfld_' + no;
//            var hndme = 'MainContent_grdBEDMView_hdnd_' + no;

//            var table = document.getElementById('<%= this.grdBEDMView.ClientID %>');
...
//            winpopupstatus = window.open('BucketCInfoDM.aspx?ID=' + BEID + '&Type=C', 'window2', 'left = ' + left + ',width=900, height=450 , menubar=no, scrollbars=yes, resizable=no');
...
//        }
        ...
        function PopUpBcktC(rowindex) {
            ...
            var MCC = document.getElementById(hndfMcc).value;
            var RF = document.getElementById(hndme).value;
            winpopupstatus = window.open('BucketDInfoDM.aspx?ID=' + BEID + '&Type=C', 'pop', 'left = ' + left + ',width=900, height=450 , menubar=no, scrollbars=yes, resizable=no');
            if (!winpopupstatus.closed)
            { winpopupstatus.focus(); }
            CalculateOnLoadFooterTotal();
            makeTextBoxRed();
        ...
        function PopUpBcktD(rowindex) {
            ...
            var MCC = document.getElementById(hndfMcc).value;
            var RF = document.getElementById(hndme).value;
            winpopupstatus = window.open('BucketDInfoDM.aspx?ID=' + BEID + '&Type=D', 'pop', 'left = ' + left + ',width=900, height=450 , menubar=no, scrollbars=yes, resizable=no');
            if (!winpopupstatus.closed)
            { winpopupstatus.focus(); }
            CalculateOnLoadFooterTotal();
            makeTextBoxRed();
        ...
        function loaddata(thisobj) {
            ...
            var grid = document.getElementById('<%= this.grdBEDMView.ClientID %>');
            for (i = 0; i < grid.rows.length - 4; i++) {



                var month1valueON = document.getElementById('MainContent_grdBEDMView_txtVolOnMonth1_' + i).value;
                var month2valueON = document.getElementById('MainContent_grdBEDMView_txtVolOnMonth2_' + i).value;
                var month3valueON = document.getElementById('MainContent_grdBEDMView_txtVolOnMonth3_' + i).value;

                var month1valueOFF = document.getElementById('MainContent_grdBEDMView_txtVolOffMonth1_' + i).value;
                var month2valueOFF = document.getElementById('MainContent_grdBEDMView_txtVolOffMonth2_' + i).value;
                var month3valueOFF = document.getElementById('MainContent_grdBEDMView_txtVolOffMonth3_' + i).value;
                ...
                document.getElementById('MainContent_grdBEDMView_lblTotOn_' + i).title = totalON.toFixed(1);
                document.getElementById('MainContent_grdBEDMView_lblTotOff_' + i).title = totalOFF.toFixed(1);
                document.getElementById('MainContent_grdBEDMView_lblTotVol_' + i).title = grandTotal.toFixed(1);
            ...
            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth1').value = SDMMonth1ONtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth1').value = SDMMonth1OFFtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth2').value = SDMMonth2ONtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth2').value = SDMMonth2OFFtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth3').value = SDMMonth3ONtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth3').value = SDMMonth3OFFtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblOnTotal').value = totalOnsite.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblOffTotal').value = totalOFFsite.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblFooterAlcon').value = totalGrandtotal.toFixed(1);

            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth1').title = SDMMonth1ONtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth1').title = SDMMonth1OFFtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth2').title = SDMMonth2ONtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth2').title = SDMMonth2OFFtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth3').title = SDMMonth3ONtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth3').title = SDMMonth3OFFtotal.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblOnTotal').title = totalOnsite.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblOffTotal').title = totalOFFsite.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblFooterAlcon').title = totalGrandtotal.toFixed(1);

          //  document.getElementById('MainContent_grdBEDMViewHorizontalBar').style.display = 'none';


        }

        function loaddataAdmin(thisobj) {
        ...
        var CalculateOnLoadFooterTotal = function () {  // calcualte footer total during OnLoad.
            ...
            for (index = 0; index < grid.rows.length - 4; index++) {
                ...
                var lbldmbe = document.getElementById('MainContent_grdBEDMView_lnkbtnDMTotal_' + index).innerText;

                dmBE += parseFloat(lbldmbe);

                var lblRtbr = document.getElementById('MainContent_grdBEDMView_lnkbtnrtbr_' + index).innerText;

                rtbr += parseFloat(lblRtbr);

                var lblVoldm = document.getElementById('MainContent_grdBEDMView_lnkbtnDMVolTotal_' + index).innerText;
                DmVol += parseFloat(lblVoldm);

                

                //               var lblAlcon = document.getElementById('MainContent_grdBEDMView_lnkbtnAlconTotal_' + index).innerText;
                ...
                TotBE = M1 + M2 + M3;
                var lbl = document.getElementById('MainContent_grdBEDMView_lblBKLeft_' + index);
                ...
                diff = TotBE - BKTotal;
                var lblBK = document.getElementById('MainContent_grdBEDMView_lblBKRight_' + index);
                ...
                //                var lvlOn = document.getElementById('MainContent_grdBEDMView_lblTotOn_' + index);
                //                var lblOff = document.getElementById('MainContent_grdBEDMView_lblTotOff_' + index);
                //                var lblVolTot = document.getElementById('MainContent_grdBEDMView_lblTotVol_' + index);
            ...
            BKdiff = MonthTotal.toFixed(1) - BK.toFixed(1);
            ...
            document.getElementById('MainContent_grdBEDMView_lblmonth1').value = dmMonth1.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblmonth2').value = dmMonth2.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblmonth3').value = dmMonth3.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonthTotal').value = text;

            document.getElementById('MainContent_grdBEDMView_lblBKmonth1').value = bkMonth1.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth2').value = bkMonth2.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth3').value = bkMonth3.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth4').value = bkMonth4.toFixed(1);

            //            document.getElementById('MainContent_grdBEDMView_lblDMBETotal').value = dmBE.toFixed(1);
            var SDMRevenueBE = document.getElementById('<%= hdSDMRevenueBE.ClientID %>');
            dmBE = parseFloat(SDMRevenueBE.value);
            document.getElementById('MainContent_grdBEDMView_lblDMBETotal').value = dmBE.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblFooterRtbr').value = rtbr.toFixed(1);


            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth1').value = volmonth1on.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth1').value = volmonth1off.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth2').value = volmonth2on.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth2').value = volmonth2off.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOnmonth3').value = volmonth3on.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblVolOffmonth3').value = volmonth3off.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblOnTotal').value = voloonfooter;
            document.getElementById('MainContent_grdBEDMView_lblOffTotal').value = volofffooter;
            document.getElementById('MainContent_grdBEDMView_lblFooterAlcon').value = voltotfooter;

            var SDMVolumeBE = document.getElementById('<%= hdSDMVolumeBE.ClientID %>');
            DmVol = parseFloat(SDMVolumeBE.value);
            document.getElementById('MainContent_grdBEDMView_lblFooterVolsdm').value = DmVol.toFixed(1);
    ...
    <script type="text/javascript">
        function AddCustomerPopUpNOChange() {
          //  debugger;
            ...
            winpopupstatus1 = window.open('AddMasterCustomer.aspx', 'pop', 'left = ' + left + ',width=330, height=260, menubar=no, scrollbars=no, resizable=no');
       ...
       document.getElementById('<%= this.grdBEDMView.ClientID %>');
...
//                grid.rows[footerrow].cells[10].innerText = sdmmonth4total.toFixed(1);
        ...
        function caldifference() {
            ...
            for (i = 0; i < grid.rows.length - 4; i++) {
                ...
                var month1value = document.getElementById('MainContent_grdBEDMView_txtBKMonth1_' + i).value;
                var month2value = document.getElementById('MainContent_grdBEDMView_txtBKMonth2_' + i).value;
                //var month3value = document.getElementById('MainContent_grdBEDMView_lnkbtnBcktC_' + i).innerText;
                var month3value = document.getElementById('MainContent_grdBEDMView_txtBKMonth3_' + i).value;
                //                var month4value = document.getElementById('MainContent_grdBEDMView_lnkbtnBcktD_' + i).innerText;
                var month4value = document.getElementById('MainContent_grdBEDMView_txtBKMonth4_' + i).value;
                ...
                var M1 = document.getElementById('MainContent_grdBEDMView_txtDMMonth1_' + i).value;
                var M2 = document.getElementById('MainContent_grdBEDMView_txtDMMonth2_' + i).value;
                var M3 = document.getElementById('MainContent_grdBEDMView_txtDMMonth3_' + i).value;
                ...
                var fName = document.getElementById('MainContent_grdBEDMView_txtBKMonth1_' + i)
                var fName1 = document.getElementById('MainContent_grdBEDMView_txtBKMonth2_' + i)
                var fName2 = document.getElementById('MainContent_grdBEDMView_txtBKMonth3_' + i)
                var fName3 = document.getElementById('MainContent_grdBEDMView_txtBKMonth4_' + i)
                //var fName2 = document.getElementById('MainContent_grdBEDMView_lnkbtnBcktC_' + i)
//                var fName3 = document.getElementById('MainContent_grdBEDMView_lnkbtnBcktD_' + i)
                var fName4 = document.getElementById('MainContent_grdBEDMView_txtDMMonth1_' + i)
                var fName5 = document.getElementById('MainContent_grdBEDMView_txtDMMonth2_' + i)
                var fName6 = document.getElementById('MainContent_grdBEDMView_txtDMMonth3_' + i)
                ...
                var Right1 = document.getElementById('MainContent_grdBEDMView_lblBKRight_' + i);
                var Left1 = document.getElementById('MainContent_grdBEDMView_lblBKLeft_' + i);
            ...
            document.getElementById('MainContent_grdBEDMView_lblBKmonthTotal').value = FooterTot;
            document.getElementById('MainContent_grdBEDMView_lblBKmonth1').value = sdmmonth1total.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth2').value = sdmmonth2total.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth3').value = sdmmonth3total.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth4').value = sdmmonth4total.toFixed(1);

            document.getElementById('MainContent_grdBEDMView_lblBKmonthTotal').title = FooterTot;
            document.getElementById('MainContent_grdBEDMView_lblBKmonth1').title = sdmmonth1total.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth2').title = sdmmonth2total.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth3').title = sdmmonth3total.toFixed(1);
            document.getElementById('MainContent_grdBEDMView_lblBKmonth4').title = sdmmonth4total.toFixed(1);
        }
        ...
        function makeTextBoxRed() {
            ...
            for (i = 0; i < grid.rows.length - 4; i++) {
                ...
                var month1value = document.getElementById('MainContent_grdBEDMView_txtDMMonth1_' + i).value;
                var month2value = document.getElementById('MainContent_grdBEDMView_txtDMMonth2_' + i).value;
                var month3value = document.getElementById('MainContent_grdBEDMView_txtDMMonth3_' + i).value;
                month1value = month1value == "" ? 0 : month1value;
                month2value = month2value == "" ? 0 : month2value;
                month3value = month3value == "" ? 0 : month3value;
                ...
                var Bk1 = document.getElementById('MainContent_grdBEDMView_txtBKMonth1_' + i).value;
                var Bk2 = document.getElementById('MainContent_grdBEDMView_txtBKMonth2_' + i).value;
                // var Bk3 = document.getElementById('MainContent_grdBEDMView_lnkbtnBcktC_' + i).innerText;
                var Bk3 = document.getElementById('MainContent_grdBEDMView_txtBKMonth3_' + i).value;
                //                var Bk4 = document.getElementById('MainContent_grdBEDMView_lnkbtnBcktD_' + i).innerText;
                var Bk4 = document.getElementById('MainContent_grdBEDMView_txtBKMonth4_' + i).value;
                Bk1 = Bk1 == "" ? 0 : Bk1;
                Bk2 = Bk2 == "" ? 0 : Bk2;
                Bk3 = Bk3 == "" ? 0 : Bk3;
                Bk4 = Bk4 == "" ? 0 : Bk4;
...
//                fName3.style.color = avg == avgBK ? "#034af3" : "red";
        ...
        function PressNumberOnlyAndCalc(thisobj) {
            ...
            if (isEror) {
                ...
                diff = totaldmmonth - totalBKFooter;
                diff = diff.toFixed(1);
                document.getElementById('MainContent_grdBEDMView_lblmonth1').value = sdmmonth1total.toFixed(1);
                document.getElementById('MainContent_grdBEDMView_lblmonth2').value = sdmmonth2total.toFixed(1);
                document.getElementById('MainContent_grdBEDMView_lblmonth3').value = sdmmonth3total.toFixed(1);
                var FooterTot = totaldmmonth + "(" + diff + ")";
                document.getElementById('MainContent_grdBEDMView_lblBKmonthTotal').value = FooterTot;

                document.getElementById('MainContent_grdBEDMView_lblmonth1').title = sdmmonth1total.toFixed(1);
                document.getElementById('MainContent_grdBEDMView_lblmonth2').title = sdmmonth2total.toFixed(1);
                document.getElementById('MainContent_grdBEDMView_lblmonth3').title = sdmmonth3total.toFixed(1);
                document.getElementById('MainContent_grdBEDMView_lblBKmonthTotal').title = FooterTot;
...
//                grid.rows[footerrow].cells[6].innerText = FooterTot;
        ...
        function PopUpDMBE(rowindex) {
            ...
            winpopupstatus = window.open('SDMDetails.aspx?ID=' + BEID , 'pop', 'left = ' + left + ',width=800, height=450 ,location=0, menubar=no, scrollbars=yes, resizable=no');
...
//            winpopupstatus = window.open('DMVolume.aspx?ID=' + BEID+'&F=' + RF , 'window2', 'left = ' + left + ',width=800, height=450 , menubar=no, scrollbars=yes, resizable=no');
            winpopupstatus = window.open('DMVolume.aspx?ID=' + BEID + '&Type=DM', 'pop', 'left = ' + left + ',width=900, height=450 , menubar=no, scrollbars=yes, resizable=no');
...
<div id="loadgif" class="progress1">
                        <div class="center">
                             <img alt="" id="img2" src="Images/load.gif" height="100" width="75"/>
                        </div>
                    </div>
    ...
    <table>
        <tr>
            <td>
                 ...
                 <asp:Button ID="btnSearch" runat="server" OnClientClick="loadinggif()" class="btn btn-info btn-sm" Height="25" style="padding-top:2px!important;border:1px solid lightgray;font-size:small" Visible="true" OnClick="btnSearch_Click"
                    Text=" Search "/>&nbsp; 
                <asp:Button ID="btnSave2" runat="server" class="btn btn-info btn-sm" Height="25" style="padding-top:2px!important;border:1px solid lightgray;font-size:small" OnClick="btnSave_DM_Click"
                ...
                &nbsp; 
                    ...
                    Text=" Include Master Customer " Visible="true"  OnClientClick="AddCustomerPopUpNOChange(); return false;"
                  ...
                  <div style="float:left;">
                    <asp:ImageButton ID="ImgDownloadToExcel" runat="server" Width="25" Height="25" ToolTip="Download To Excel"
                                        ImageUrl="~/Images/excel.png" OnClientClick="loadinggif()" OnClick="ImgDownloadToExcel_Click"/>
                                        </div>
                    <div style="float:left;"><img style="display: none;height:25px;width:25px" alt="loading.." id="imgloadinggif" src="Images/ExcelLoading.gif"/></div>
                                         ...
                                         <div id="bulk" visible="false" style="top: 0px; height: 25px !important; margin-top: 0px; margin-left: 10px;display:none;
                        ...
                        <div style="float:left;height:10px">
                          <asp:Label ID="lblBulk" runat="server" Text="Bulk BE Update"  Font-Names="Calibri" Font-Size="10pt" style="padding-left:10px"></asp:Label> </div>
                            <div style="float:left;clear:both;height:10px"> <asp:LinkButton ID="lbBulkUpdate" runat="server"  Font-Names="Calibri" Enabled="false"
                                Font-Size="10pt" OnClick="lbBulkUpdate_Click" OnClientClick="loadinggif()" ToolTip="Please ensure correct Quarter is selected from the dropdown">Download</asp:LinkButton>
                        ...
                        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" align="center" Height="32px"
                            ...
                            <span><strong>
                                <asp:FileUpload ID="fuUploader" runat="server" Font-Names="Verdana" OnChange="return validateFile()"
                                    Style="width: 276px !important; height: 23px ;padding-top: 2px!important; font-size: small" />
                                &nbsp;<asp:Button ID="btnUpload" runat="server" class="btn btn-info btn-sm" Height="25"
                                    Font-Names="Verdana" OnClientClick="return validateUpload()"  OnClick="btnUpload_Click" Enabled="false"
                                    Text="Upload" Style="display:none; padding-top: 2px!important; border: 1px solid lightgray;margin-bottom:4px;
                                    font-size: small" />
                                &nbsp;</strong> 
                         <asp:Button ID="btnCancel" runat="server" Font-Names="Verdana" Text="Close"
                                    class="btn btn-danger btn-sm" Height="25" Style="padding-top: 2px!important;margin-bottom:4px;
                                    border: 1px solid lightgray; font-size: small;font-weight:bold" />
                                &nbsp;  </span>    <br />
                        </asp:Panel>
                        ...
                        <asp:Panel ID="Panel2" runat="server" CssClass="modalPopup" align="center" Width="500px" Height="300px"
                            Style="display: none">
                            ...
                            <div >
                                <asp:Label ID="lblFinalMessage" runat="server" Height="25" Style="width: 100%; padding-top: 2px!important;
                                    padding-bottom: 10px!important;margin-bottom: 14px; border: none; font-size: small; font-weight: bold"></asp:Label>
                            </div>
                            <div style="margin-right:10px;overflow-y:scroll;height:125px" >
                                    <asp:GridView ID="GVErrorMsg" AutoGenerateColumns="true" style="width:100%" HeaderStyle-BackColor="#333333"  HeaderStyle-ForeColor="White"  Visible="false" runat="server"></asp:GridView>
                            </div>                           
                        </asp:Panel>
 ...
 <div align="center" style="padding-left:30px;">
               ...
               <asp:GridView ID="grdBEDMView" runat="server" AutoGenerateColumns="False" ShowFooter="True" 
               EmptyDataText="No records found" OnRowCommand="grdBEDMView_RowCommand"
                OnRowCreated="grdBEDMView_RowCreated" OnRowDataBound="gvUserInfo_RowDataBound"
                    CssClass="mGrid" >
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="MCC-DM-Offering" SortExpression="SkillType" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                              <div class="wid">
                            <asp:HiddenField ID="hdnfmcc" Value='<%# Bind("txtMasterClientCode") %>' runat="server"></asp:HiddenField>
                                <asp:Label ID="lblMCC" runat="server" style="white-space:nowrap" Text='<%#Eval("txtMasterClientCode")+ "-" + Eval("NewOffering")%>' ToolTip='<%# Bind("txtMasterCustomerName") %>'></asp:Label>
                              </div>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Month1" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            ...
                            <div style="width:45px">
                                <asp:TextBox ID="txtDMMonth1" Text='<%# Bind("fltDMMonth1BE") %>' Height="15" Width="38"
                        ...
                        <asp:TemplateField HeaderText="Month2" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                <asp:TextBox ID="txtDMMonth2" Text='<%# Bind("fltDMMonth2BE") %>' Height="15" Width="38"
                                    CssClass="TextBox" runat="server"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
                               <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Month3" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                <asp:TextBox ID="txtDMMonth3" Text='<%# Bind("fltDMMonth3BE") %>' Height="15" Width="38"
                                    CssClass="TextBox" runat="server"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="BETotal" SortExpression="TotalVol" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div class="BETotal">
                                <asp:Label ID="lblBKLeft" runat="server" Text='<%# Bind("fltDMQuarterBE") %>'></asp:Label>
                        ...
                        <asp:TemplateField HeaderText="DMBE" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            ...
                            <div style="width:55px">
                                <asp:HyperLink ID="lnkbtnDMTotal" runat="server" Text='<%# Bind("SDMRevenueBE") %>'
                        ...
                        <asp:TemplateField HeaderText="On" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                <asp:TextBox ID="txtVolOnMonth1" Text='<%# Bind("fltDMMonth1onsite") %>' Height="15"
                        ...
                        <asp:TemplateField HeaderText="Off" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                <asp:TextBox ID="txtVolOffMonth1" Text='<%# Bind("fltDMMonth1offsite") %>' Height="15"
                                    Width="40" CssClass="TextBox" runat="server"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="On" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                <asp:TextBox ID="txtVolOnMonth2" Text='<%# Bind("fltDMMonth2onsite") %>' Height="15"
                                    Width="40" CssClass="TextBox" runat="server"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
                           <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Off" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                <asp:TextBox ID="txtVolOffMonth2" Text='<%# Bind("fltDMMonth2offsite") %>' Height="15"
                                    Width="40" CssClass="TextBox" runat="server"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
                             <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="On" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                <asp:TextBox ID="txtVolOnMonth3" Text='<%# Bind("fltDMMonth3onsite") %>' Height="15"
                                    Width="40" CssClass="TextBox" runat="server"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
                             <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Off" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                <asp:TextBox ID="txtVolOffMonth3" Text='<%# Bind("fltDMMonth3offsite") %>' Height="15"
                                    Width="40" CssClass="TextBox" runat="server"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
                           <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="On" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                             <div style="width:45px">
                                 <asp:TextBox ID="lblTotOn" ReadOnly ="true" Text='<%# Bind("fltDMTotalonsite") %>' ToolTip='<%# Bind("fltDMTotalonsite") %>' CssClass="footerBox1" runat="server" BorderWidth="0"  Width="40"/>
                               </div>
                            </ItemTemplate>
                               <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="Off" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                             <div style="width:40px">
                              <asp:TextBox ID="lblTotOff" ReadOnly ="true" Text='<%# Bind("fltDMTotaloffsite") %>' ToolTip='<%# Bind("fltDMTotaloffsite") %>'  CssClass="footerBox1" runat="server" BorderWidth="0"  Width="37"/>
                          </div>
                            </ItemTemplate>
                              <FooterTemplate>
                        ...
                        <asp:TemplateField HeaderText="TotalVol" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                              <div style="width:42px">
                                  <asp:TextBox ID="lblTotVol" ReadOnly ="true" Text='<%# Bind("fltDMQuarterVol") %>' ToolTip='<%# Bind("fltDMQuarterVol") %>'  CssClass="footerBox1" runat="server" BorderWidth="0"  Width="40"/>
                          </div>
                            </ItemTemplate>
                                <HeaderStyle  Width="42" />
                            
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="DM Reasons for Rev & Vol changes"
                            HeaderStyle-HorizontalAlign="Center" HeaderStyle-Wrap="true" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:85px">
                                <asp:TextBox ID="txtVolsdmRemarks" Text='<%# Bind("txtDMBERemarks") %>' ToolTip='<%# Bind("txtDMBERemarks") %>'
                                    Height="15" Width="82" runat="server" MaxLength="180" Font-Size="X-Small"></asp:TextBox>
                                    </div>
                            </ItemTemplate>
  <FooterTemplate>
                                   
                             <asp:TextBox ID="lblFooterVolsdm"  CssClass="footerBox" BorderWidth="0"  runat="server" Width="38"/>
                        ...
                        <asp:TemplateField HeaderText="DMVolBE" SortExpression="SkillType" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <div style="width:54px">
                                  <asp:HyperLink ID="lnkbtnDMVolTotal" runat="server" Text='<%# Bind("SDMVolumeBE") %>'
                                     NavigateUrl="#" onclick="PopUpDMBE(this); return false;"></asp:HyperLink>
                                      </div>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <%-- <asp:TemplateField   SortExpression="SkillType" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                            <div style="width:45px">
                                   ...
                                   <HeaderStyle Wrap="true" Width="47" />
                ...
                <asp:HiddenField ID="hdSDMRevenueBE" runat="server" />
                <asp:HiddenField ID="hdSDMVolumeBE" runat="server" />
  ...
  <script type="text/javascript">
      ...
      function gridviewScroll() {
          ...
          console.log('gridviewScroll ' + new Date().getTime());
         <%-- $('#<%=grdBEDMView.ClientID%>').gridviewScroll({
              width:1280,
              height: 370,
              headerrowcount: 3,
          ...
          var gridViewScroll = new GridViewScroll({
              elementID: 'MainContent_grdBEDMView',
              width: 1315, // Integer or String(Percentage)
