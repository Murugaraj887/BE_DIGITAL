<%@ Page Language="C#" AutoEventWireup="true"
    Title="Finpulse" Inherits="ReportFinpulse" Codebehind="ReportFinpulse.aspx.cs" %>
...
<body>
    ...
    <div align="center">
        <table width="100%">
            <tr>
                <td align="center">
                    <asp:Label ID="lbldisplayFin" runat="server" Font-Names="Calibri" Font-Size="11px"
                        ForeColor="Red" Font-Bold="true" Text="Finpulse last modified on : "></asp:Label>
                           ...
                           <td >
                                    ...
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlSU" runat="server" Font-Names="Calibri" Font-Size="11px"
                                                OnSelectedIndexChanged="ddlSU_SelectedIndexChanged" AutoPostBack="True" style="margin-left:5px"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlPU" runat="server" Font-Names="Calibri" Font-Size="11px"
                                                AutoPostBack="True" OnSelectedIndexChanged="ddlPU_SelectedIndexChanged"  style="margin-left:5px"
                                                Height="25" class="form-control" width="78">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                            ...
                            <td class="FormControls">
                                <table >
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlMCC" runat="server" Font-Names="Calibri" Font-Size="11px" style="margin-left:5px" 
                                            Height="25" class="form-control" width="200">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlYear" runat="server" Font-Names="Calibri" Font-Size="11px"
                                                AutoPostBack="True" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged" style="margin-left:5px"
                                                Height="25" class="form-control" width="78">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
